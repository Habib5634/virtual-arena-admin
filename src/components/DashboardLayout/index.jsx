            ...
            >
                ...
                <nav>
                    <ul>
                        ...
                        <li className="p-4">
                            <Link
                                href="/bookings/all-bookings"
                                className={`flex items-center ${pathname === '/bookings/all-bookings' ? "text-gradiant font-bold" : ""}`}
                            >
                                <div className='flex items-center gap-2 leading-none'>
                        ...
                        />
                         ...
                         <li className="p-4">
                            <Link
                                href="/orders"
                                className={`flex items-center ${pathname === '/orders' ? "text-gradiant font-bold" : ""}`}
                            >
                                <div className='flex items-center gap-2 leading-none'>
                                    <LuClipboardList className='text-[#926BB9]' size={20} />
                                    {isSidebarOpen && "Orders"} {/* Show text only when sidebar is open */}
                                </div>
                            </Link>
                        </li>
                         {/* Payments */}
                         <li className="p-4">
                            <Link
                                href="/payments"
                                className={`flex items-center ${pathname === '/payments' ? "text-gradiant font-bold" : ""}`}
                            >
                                <div className='flex items-center gap-2 leading-none'>
                         ...
                         <li className="p-4">
                            <Link
                                href="/users"
                                className={`flex items-center ${pathname === '/users' ? "text-gradiant font-bold" : ""}`}
                            >
                                <div className='flex items-center gap-2 leading-none'>
                         ...
                         <li className="p-4">
                            <Link
                                href="/notifications"
                                className={`flex items-center ${pathname === '/notifications' ? "text-gradiant font-bold" : ""}`}
                            >
                                <div className='flex items-center gap-2 leading-none'>
                                    <FaBell className='text-[#926BB9]' size={20} />
                                    {isSidebarOpen && "Notifications"} <span className='text-red-500'>{notifications.some((n) => !n.is_read) && `${notifications.filter((n) => !n.is_read).length}`}</span>
                                </div>
                            </Link>
                        </li>
                    </ul>
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <div className="relative">
                            <button onClick={toggleProfile} className="flex items-center gap-1 focus:outline-none">
                                <img src="/assets/logo.png" className='h-9 w-9 rounded-full' alt="" />
